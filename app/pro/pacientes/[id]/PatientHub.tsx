    ...
    <div>
      ...
      <div className="p-8 max-w-5xl">
        ...
        <div className="grid grid-cols-5 gap-3 mb-10">
          {[
            { href: `/pro/pacientes/${patient.id}/protocolo`,        icon: '🩺', label: 'Protocolo',      desc: 'Visão da consulta' },
            { href: `/pro/pacientes/${patient.id}/resumo-whatsapp`, icon: '💬', label: 'Resumo WA',    desc: 'Relatório semanal' },
            { href: `/pro/pacientes/${patient.id}/evolucao`,    icon: '📈', label: 'Evolução',  desc: 'Gráficos e metas' },
