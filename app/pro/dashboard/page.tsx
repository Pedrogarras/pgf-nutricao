      ...
      <div className="p-8">
        ...
        <div className="grid grid-cols-7 gap-3 mb-8">
          {[
            ...
            { href: '/pro/semana',         icon: '📅', label: 'Semana',            desc: 'Grid de aderência',        color: '#10B981' },
            { href: '/pro/notificacoes',   icon: '🔔', label: 'Follow-up',         desc: 'Notificações & lembretes', color: '#F59E0B' },
            { href: '/pro/mensagens',      icon: '💬', label: 'Mensagens',         desc: 'Templates WhatsApp',       color: '#22C55E' },
            { href: '/pro/agenda',         icon: '🗓️', label: 'Agenda',            desc: 'Consultas agendadas',      color: '#EF4444' },
